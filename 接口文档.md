...
- JSON类型：自定义类型。
  ...
  ```
   ...
   3.5.3 返回数据 ```json { "Status":0, "Message":" NewsTripletsExtraction", "NewsId":"473b0005-3ad2-4d50-8cb5-978b3dfd7ef3", "Data":{ "SentenceNum":10, "EffectTripletsNum":30, "Sentences":[{
